...
- 린 스타트업 개념은 그로스해킹과 닿아있다.
	- 아이디어 --> 개발 --> 측정 --> 개선 --> 아이디어 -->..
	- 최대한 빨리 작은 성공 쌓기 - 
- 그로스 해킹 :  *상호작용 가능한 여러 직군의 멤버들이 모여서 핵심 지표를 중심으로 실험을 통해 배움(데이터)을 얻고, 이를 빠르게 반복하면서 제품이나 서비스를 성장시키는 것*
	- 상호작용 가능한 여러직군
	- 핵심지표
	- 실험-반복
	- 성장
...
- PMF는 넷스케이크 창업자인 마크 앤드리슨의 "좋은 시장에, 그 시장을 만족시킬 수 있는 제품을 갖고 있는 것" 이란 설명에서 시작됐다.
